...
def start_screen():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.transform.smoothscale(pygame.image.load("media/play button.png"),(135,176)), pos=(700, 500),
                             text_input="PLAY", font=get_font(25), base_color="lightsalmon3", hovering_color="#82cf88")

        INFO_BUTTON = Button(image=pygame.transform.smoothscale(pygame.image.load("media/info button.png"), (200, 241)),
                             pos=(580, 510),
